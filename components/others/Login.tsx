        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="space-y-5 flex flex-col items-start">
              <p className="text-[13px] cursor-pointer font-light">
                Forgot Password?
              </p>
              <p className="text-[13px] font-light">
                Don&apos;t have an Account?
                <strong className="ml-2 text-xs cursor-pointer font-bold underline underline-offset-4 text-[#5c2653]hover:text-[#8a3a7d]">
                  Register Now!
                </strong>
              </p>
            </div>
